					...
					<div class="row">
						<div class="col-md-11 col-lg-10 col-xl-9">
							<div class="about-2-title mb-60">
								...
								<!-- Title -->
								<h2 class="s-52 w-700 mb-30">Vision Statement</h2>

								<!-- Text -->	
								<p class="mb-0">To be the leading digital agency in Perth, empowering small businesses with innovative, results-driven solutions that transform their online presence and drive sustainable growth.
								</p>
					...
					<div class="row">	
						...
						<div class="col-md-6">
							<div id="a3-1" class="txt-block">	
								...
								<!-- Title -->
								<h5 class="s-24 w-700 mb-20">Mission Statement</h5>

								<!-- Text -->	
								<p>Our mission is to provide small businesses with tailored web development, SEO, and social media management services that enhance their visibility, engage their audience, and foster long-term success in the digital landscape.
								</p>
...
<!-- 								<ul class="simple-list">
						...
						<div class="col-md-6">
							<div id="a3-2" class="txt-block">	
								...
								<!-- Title -->
								<h5 class="s-24 w-700 mb-20">Our Storys</h5>

								<!-- Text -->	
								<p>Founded with a passion for helping small businesses thrive in the digital world, WebCore Digital Solutions was established to deliver high-quality, customized digital services. We understand the challenges that small businesses face, and our goal is to be a trusted partner in your journey to online success.
								</p>

								<!-- Text -->	
<!-- 								<p class="mb-0">Egestas volute nemo ipsam turpis egestas ipsum and purus sapien ultrice an 
					...
					<div class="row justify-content-center">	
						<div class="col-md-10 col-lg-9">
							<div class="section-title mb-70">
								...
								<!-- Title -->	
								<h2 class="s-50 w-700">Why Choose Us?</h2>	
							...
							<!-- FEATURE BOX #1 -->
		 					<div class="col">
		 						<div class="fbox-11 fb-1 wow fadeInUp">
									...
									<!-- Text -->
									<div class="fbox-txt">
										<h6 class="s-22 w-700">Personalized Solutions</h6>
										<p>We tailor our services to meet your specific business needs.
										</p>
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-11 fb-2 wow fadeInUp">
									...
									<!-- Text -->
									<div class="fbox-txt">
										<h6 class="s-22 w-700">Proven Expertise</h6>
										<p>Our team stays ahead of the curve with the latest digital trends and techniques.
										</p>
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-11 fb-3 wow fadeInUp">
									...
									<div class="fbox-txt">
										...
										<p>We’re with you every step of the way, from strategy development to execution and beyond.
										</p>
									</div>
		 					...
		 					<div class="col">
		 						<div class="fbox-11 fb-4 wow fadeInUp">
									...
									<!-- Text -->
									<div class="fbox-txt">
										<h6 class="s-22 w-700">Our Team</h6>
										<p>Our team of skilled professionals brings together years of experience in web development, SEO, and social media management. We are committed to delivering results that make a real difference to your business.
										</p>
									</div>
						...
						<div class="row d-flex align-items-center row-cols-1 row-cols-lg-2">
							...
							<div class="col">
								<div class="newsletter-txt">	
									<h4 class="s-34 w-700">Learn more about how we can help your business grow. Get in Touch with us today.</h4>	
								</div>								
							</div>
