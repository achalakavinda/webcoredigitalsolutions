                        ...
                        <div class="wsmainwp clearfix">
                            ...
                            <nav class="wsmenu clearfix">
                                <ul class="wsmenu-list nav-theme">
                                    ...
                                    <li class="nl-simple" aria-haspopup="true"><a href="about.html" class="h-link">About</a>
                                    </li>
                                    <li class="nl-simple" aria-haspopup="true"><a href="contacts.html"
                        ...
                        <div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
                            ...
                            <div class="col">
                                <div class="footer-copyright">
                                    <p class="p-sm">&copy; 2023 Web Core Digital Solutions. <span>All Rights Reserved</span></p>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="bottom-secondary-link ico-15 text-end">
                                    <p class="p-sm"><a href="https://themeforest.net/user/dsathemes/portfolio">Made with
                                            <span class="flaticon-heart color--pink-400"></span> by @webcoredigitalsolutions</a>
                                    </p>
                                </div>
                            </div>
